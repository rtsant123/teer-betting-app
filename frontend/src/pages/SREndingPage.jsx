...
const SREndingPage = () => {
  ...
  const getTotalPotentialPayout = () => {
    const payoutRate = houseData?.house?.sr_ending_payout_rate || 8;
  ...
  const placeBets = async () => {
    ...
    try {
      ...
      const betData = {
        ...
        sr_ending: endingNumbers  // Changed to use new schema
      };

      console.log('Sending SR ending bet data:', betData);

      await api.post('/bet/ticket', betData);
      
      toast.success('SR ending bet placed successfully!');
        ...
        <div className="max-w-lg mx-auto px-3 sm:px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center flex-1">
              <h1 className="text-lg sm:text-xl font-semibold text-gray-800">SR Ending</h1>
